...
DRAW_COL        PSHS A,B,X
                ...
                ABX
                STX HEIGHT_ARRAY_P,PCR
                LEAX 1,X
                STX HEIGHT_ARRAY_P2,PCR
                LDX COLOR_ARRAY,PCR
                ABX
                STX COLOR_ARRAY_P,PCR
                LEAX 1,X
                STX COLOR_ARRAY_P2,PCR
...
DRAW_COL_H1     ; segment 1 : count = sky_height=middle - line_height1, color = sky, sky
                ...
                LDB [HEIGHT_ARRAY_P,PCR]
                SUBB [HEIGHT_ARRAY_P2,PCR]
                LDA [COLOR_ARRAY_P,PCR]
                ...
                LDB [HEIGHT_ARRAY_P2,PCR]
                LSLB                    ; line_height2 * 2
                ANDA #$F0
                ADDA [COLOR_ARRAY_P2,PCR]
                BSR VBLAST            
...
DRAW_COL_END    PULS A,B,X, PC  ; cleanup and RTS
...
VBLAST          ; input:
                ...
                ADDB #100
                LSLB                   ; multiply D by 4 (each STA takes 4 bytes)
                ROLA
                LSLB
                ROLA
